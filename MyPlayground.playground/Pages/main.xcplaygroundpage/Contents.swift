...
func name (charactersName: String){
    print("My favorite character is \(charactersName).")
}
...
let jon = "The King in the North."
name(jon)
var arya = "A girl has no name"
name(arya)
/*: question5
...
favoriteBand(bandName, number: num)
...
madLib("Jon", noun: "King's Landing", preposition: "after")
